...
const DeleteWikiRuleConfirm = lazyNamed<typeof import('./modals/NoticeWikiModals').DeleteWikiRuleConfirm>(() => import('./modals/NoticeWikiModals'), 'DeleteWikiRuleConfirm');
