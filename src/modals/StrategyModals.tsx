                      ...
                      <div>
                        <div className="grid grid-cols-3 gap-2">
                          ...
                          <button
                            ...
                            className="aspect-video rounded-lg border border-dashed border-zinc-700 hover:border-zinc-500 flex flex-col items-center justify-center gap-1 text-zinc-500 hover:text-zinc-300 transition-all bg-zinc-800"
                          >
                            <ImagePlus className="w-4 h-4" />
